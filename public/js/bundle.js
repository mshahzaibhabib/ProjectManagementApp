...
},{"./lib/axios":"../../node_modules/axios/lib/axios.js"}],"projectOperations.js":[function(require,module,exports) {
"use strict";
...
if (addNewProjectForm) {
  ...
  addNewProjectForm.addEventListener('submit', function (e) {
    ...
    for (var i = 0; i < developerCheckboxes.length; i++) {
